...
# 4. C#
- [.NET Data Types 1](https://www.tutorialspoint.com/vb.net/vb.net_data_types.htm)
- [.NET Data Types 2](https://docs.microsoft.com/en-us/windows/win32/wmp/about--net-framework-data-types)
```
sbyte myByte = 64;                                  // Integral Number : 1 byte
...
byte myByte = 64;                                   // Unsigned Integral Number : 1 byte

uhort myShort = 156;                                // Unsigned Integral Number : 2 bytes

uint myInt = 4566;                                  // Unsigned Integral Number : 4 bytes

ulong myLong = 456897;                              // Unsigned Integral Number : 8 bytes
...
# 7. Rust
```
i8, i16, i32, i64, i128                             // Primitive Type : Signed Integers
let myInt : i32 = -123;

u8, u16, u32, u64, u128                             // Primitive Type : Unsigned Integers
let myUInt : u32 = 123;

f32, f64                                            // Primitive Type : Floating-point number : default -> f64
let myFloat : f32 = 5.6;

let myBool : bool = true;                           // Primitive Type : Boolean

let myChar = 'c';                                   // Primitive Type : character


let myTuple : (i32, u64, f32) = (-230, 1200, 5.1);  // Compound Type : Tuple

let myArray = [1, 2, 3];                            // Compound Type : Array
```
